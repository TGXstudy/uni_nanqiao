<template>
	<view class="tui-numberbox-class tui-numberbox">
		...
		<input type="number" v-model="val" :disabled="true" @blur="blur" class="tui-num-input" :style="{color:color,fontSize:px(iconsize),background:bgcolor,height:px(height),width:px(width)}" />
